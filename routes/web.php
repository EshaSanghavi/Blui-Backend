...
use App\Http\Controllers\WEB\Admin\OrderReportController;
...
use App\Http\Controllers\WEB\Admin\SupportTicketController;
...
use App\Http\Controllers\WEB\Admin\ProductAttributeController;
...
use App\Http\Controllers\WEB\Seller\SellerSupportTicketController;
...
use App\Http\Controllers\WEB\Admin\OPAController;

use App\Http\Controllers\WEB\OPA\Auth\OPARegisterController;
use App\Http\Controllers\WEB\OPA\Auth\OPALoginController;
use App\Http\Controllers\WEB\OPA\OPADashboardController;
use App\Http\Controllers\WEB\OPA\OPASellerController;
...
Route::group(['middleware' => ['maintainance']], function () {
    ...
    Route::group(['as'=> 'seller.', 'prefix' => 'seller'],function (){
        ...
        Route::get('register', [SellerRegisterController::class,'registerPage'])->name('register');
        Route::post('register', [SellerRegisterController::class,'store'])->name('register.submit');

        Route::get('login', [SellerLoginController::class,'sellerLoginPage'])->name('login');
        Route::post('login', [SellerLoginController::class,'storeLogin'])->name('login');
        Route::get('logout', [SellerLoginController::class,'adminLogout'])->name('logout');


        Route::get('dashboard',[SellerDashboardController::class,'index'])->name('dashboard');
        Route::get('/',[SellerProfileController::class,'initialDetails'])->name('initial-details');
        Route::post('/',[SellerProfileController::class,'initialDetailsStore'])->name('initial-details-store');
        Route::get('my-profile',[SellerProfileController::class,'index'])->name('my-profile');
        Route::get('state-by-country/{id}',[SellerProfileController::class,'getStateByCountry'])->name('state-by-country');
        Route::get('city-by-state/{id}',[SellerProfileController::class,'getCityByState'])->name('city-by-state');
        ...
        Route::get('product-select-category',[SellerProductController::class,'selectCategory'])->name('product-select-category');
        Route::post('create-product',[SellerProductController::class,'newProductCategory'])->name('create-product');    
        Route::post('store-product',[SellerProductController::class,'store'])->name('store-product');  
        ...
        Route::get('progress-order', [SellerOrderController::class, 'progressOrder'])->name('progress-order');
        Route::get('dispatch-ready-order', [SellerOrderController::class, 'dispatchReadyOrder'])->name('dispatch-ready-order');
        ...
        Route::post('update-order-status', [SellerOrderController::class, 'updateOrderStatus'])->name('update-order-status');

        Route::resource('support-ticket', SellerSupportTicketController::class);
        Route::get('all-support-ticket', [SellerSupportTicketController::class, 'index'])->name('all-support-ticket');
        Route::get('raise-support-ticket', [SellerSupportTicketController::class, 'create'])->name('raise-support-ticket');
        Route::post('support-ticket-store', [SellerSupportTicketController::class, 'store'])->name('support-ticket-store');
        ...
        Route::get('opa/register', [OPAController::class,'opaRegisterPage'])->name('register');
    ...
    //OPA routes 
    Route::get('opa/dashboard',[OPADashboardController::class,'index'])->name('opa.dashboard');
    // start auth route
    Route::get('opa/register', [OPARegisterController::class,'registerPage'])->name('opa.register');
    Route::post('opa/register', [OPARegisterController::class,'store'])->name('opa.register.submit');

    Route::get('opa/login', [OPALoginController::class,'loginPage'])->name('opa.login');
    Route::post('opa/login', [OPALoginController::class,'dashboardLogin'])->name('opa.login.submit');
    Route::get('opa/logout', [OPALoginController::class, 'adminLogout'])->name('opa.logout');
    // end auth route
    Route::group(['as'=> 'opa.', 'prefix' => 'opa'],function (){

        // start auth route
        Route::get('register', [OPARegisterController::class,'registerPage'])->name('register');
        Route::post('register', [OPARegisterController::class,'store'])->name('register.submit');

        Route::get('login', [OPALoginController::class,'loginPage'])->name('login');
        Route::post('login', [OPALoginController::class,'dashboardLogin'])->name('login.submit');
        Route::get('logout', [OPALoginController::class, 'adminLogout'])->name('logout');
        // end auth route

        Route::get('/', [OPADashboardController::class,'index'])->name('opa.dashboard');
        Route::get('profile', [OPAProfileController::class,'index'])->name('profile');
        Route::put('profile-update', [OPAProfileController::class,'update'])->name('profile.update');
        
       
        Route::resource('seller', OPASellerController::class);
        Route::get('seller-list',[OPASellerController::class,'index'])->name('seller-list');
        Route::get('seller-show/{id}',[OPASellerController::class,'show'])->name('seller-show');
        Route::put('seller-status/{id}',[OPASellerController::class,'changeStatus'])->name('seller-status');
        Route::delete('seller-delete/{id}',[OPASellerController::class,'destroy'])->name('seller-delete');
        Route::get('seller-create',[OPASellerController::class,'create'])->name('seller-create');
        Route::get('pending-seller-list',[OPASellerController::class,'pendingSellerList'])->name('pending-seller-list');
        Route::put('seller-update/{id}',[OPASellerController::class,'updateSeller'])->name('seller-update');
        Route::get('seller-shop-detail/{id}',[OPASellerController::class,'sellerShopDetail'])->name('seller-shop-detail');
        Route::put('remove-seller-social-link/{id}',[OPASellerController::class,'removeSellerSocialLink'])->name('remove-seller-social-link');
    
        Route::put('update-seller-shop/{id}',[OPASellerController::class,'updateSellerShop'])->name('update-seller-shop');
        Route::get('seller-reviews/{id}',[OPASellerController::class,'sellerReview'])->name('seller-reviews');
        Route::get('show-seller-review-details/{id}',[OPASellerController::class,'showSellerReviewDetails'])->name('show-seller-review-details');
        Route::get('send-email-to-seller/{id}',[OPASellerController::class,'sendEmailToSeller'])->name('send-email-to-seller');
        Route::post('send-mail-to-single-seller/{id}',[OPASellerController::class,'sendMailtoSingleSeller'])->name('send-mail-to-single-seller');
        Route::get('email-history/{id}',[OPASellerController::class,'emailHistory'])->name('email-history');
        Route::get('product-by-seller/{id}',[OPASellerController::class,'productBySaller'])->name('product-by-seller');
        Route::get('send-email-to-all-seller',[OPASellerController::class,'sendEmailToAllSeller'])->name('send-email-to-all-seller');
        Route::post('send-mail-to-all-seller',[OPASellerController::class,'sendMailToAllSeller'])->name('send-mail-to-all-seller');
        Route::get('withdraw-list/{id}',[OPASellerController::class,'sellerWithdrawList'])->name('withdraw-list');
    
    
        Route::get('state-by-country/{id}',[OPASellerController::class,'stateByCountry'])->name('state-by-country');
        Route::get('city-by-state/{id}',[OPASellerController::class,'cityByState'])->name('city-by-state');
...
Route::group(['as'=> 'admin.', 'prefix' => 'admin'],function (){
    ...
    //Start report routes
    Route::get('earning-report', [ReportController::class,'earningReport'])->name('earning-report');
    Route::get('inhouse-sales', [ReportController::class,'earningReport'])->name('inhouse-sales');
    Route::get('vendor-sales', [ReportController::class,'vendorSales'])->name('vendor-sales');
    Route::get('transaction-report', [ReportController::class,'transactionReport'])->name('transaction-report');

    Route::get('all-product-report',[ReportController::class, 'allProducts'])->name('all-product-report');
    ...
    Route::get('product-in-wishlist',[ReportController::class, 'whishlistProducts'])->name('product-in-wishlist');


    Route::get('order-report',[OrderReportController::class, 'index'])->name('order-report');
    Route::get('show-order-report/{id}',[OrderReportController::class, 'show'])->name('show-order-report');
    Route::delete('delete-order-report/{id}',[OrderReportController::class, 'destroy'])->name('delete-order-report');
    Route::put('de-active-order/{id}',[OrderReportController::class, 'deactiveProduct'])->name('de-order-product');
    //End report routes


    // Start Support ticket
    Route::resource('support-ticket', SupportTicketController::class);
    Route::get('seller-raised-support-ticket', [SupportTicketController::class, 'sellerTicketsRaised'])->name('seller-raised-support-ticket');
    Route::get('seller-resolved-support-ticket', [SupportTicketController::class, 'sellerTicketsResolved'])->name('seller-resolved-support-ticket');
    Route::get('opa-raised-support-ticket', [SupportTicketController::class, 'opaTicketsRaised'])->name('opa-raised-support-ticket');
    Route::get('opa-resolved-support-ticket', [SupportTicketController::class, 'opaTicketsResolved'])->name('opa-resolved-support-ticket');
    // End Support ticket
    ...
    Route::get('product-select-category',[ProductController::class,'selectCategory'])->name('product-select-category');
    Route::post('create-product',[ProductController::class,'newProductCategory'])->name('create-product');
    ...
    Route::get('product-attribute-secret', [ProductAttributeController::class,'get_multi_entry'])->name('product-attribute-secret');
    Route::post('product-attribute-secret-store', [ProductAttributeController::class,'multi_entry'])->name('product-attribute-secret-store');
    Route::get('product-attribute', [ProductAttributeController::class,'index'])->name('product-attribute');
    Route::post('attribute-store', [ProductAttributeController::class,'store'])->name('attribute-store');
    Route::get('create-product-attribute', [ProductAttributeController::class,'create'])->name('create-product-attribute');
    Route::delete('delete-attribute/{id}', [ProductAttributeController::class, 'destroy'])->name('delete-attribute');
    Route::put('edit-product-attribute/{id}', [ProductAttributeController::class,'edit'])->name('edit-product-attribute');
    Route::post('update-attribute/{id}', [ProductAttributeController::class, 'update'])->name('update-attribute');
    ...
    Route::put('update-seller-shop/{id}',[SellerController::class,'updateSellerShop'])->name('update-seller-shop');
    ...
    Route::resource('opa', OPAController::class);
    Route::get('opa-list',[OPAController::class,'index'])->name('opa-list');
    Route::get('opa-show/{id}',[OPAController::class,'show'])->name('opa-show');
    Route::put('opa-status/{id}',[OPAController::class,'changeStatus'])->name('opa-status');
    Route::delete('opa-delete/{id}',[OPAController::class,'destroy'])->name('opa-delete');
    Route::get('opa-create',[OPAController::class,'create'])->name('opa-create');
    Route::get('pending-opa-list',[OPAController::class,'pendingOPAList'])->name('pending-opa-list');
    Route::put('opa-update/{id}',[OPAController::class,'updateOPA'])->name('opa-update');
    Route::get('opa-shop-detail/{id}',[OPAController::class,'opaShopDetail'])->name('opa-shop-detail');
    Route::put('remove-opa-social-link/{id}',[OPAController::class,'removeOPASocialLink'])->name('remove-opa-social-link');
    Route::get('send-email-to-opa',[OPAController::class,'sendEmailToOPA'])->name('send-email-to-opa');
    Route::post('send-mail-to-all-opa',[OPAController::class,'sendMailToAllOPA'])->name('send-mail-to-all-opa');
    Route::post('send-email-to-all-opa',[OPAController::class,'sendMailToAllOPA'])->name('send-email-to-all-opa');
    ...
    Route::get('progress-order', [OrderController::class, 'progressOrder'])->name('progress-order');
    Route::get('dispatch-ready-order', [OrderController::class, 'dispatchReadyOrder'])->name('dispatch-ready-order');
