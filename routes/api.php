...
Route::group([''], function () {
    ...
    Route::get('/product-by-sub-category/{id}', [HomeController::class, 'productByChildCategory'])->name('product-by-sub-category');
    Route::get('/product-by-child-category/{id}', [HomeController::class, 'productBySubCategory'])->name('product-by-child-category');
