        ...
        <div class="col-md-4"></div>
          <div class="col-md-4">
            ...
            <div class="card card-primary">
              <div class="card-header"><h4>{{__('admin.Seller Registration')}}</h4></div>

              <div class="card-body">
                <form class="needs-validation" method="POST" id="adminLoginForm" action="{{ route('seller.register.submit') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-12">
                            ...
                            <input type="text" id="referral" class="form-control"  name="referral" value="">
                        </div>
