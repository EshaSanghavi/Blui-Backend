      ...
      <div class="main-content">
        <section class="section">
          ...
          <div class="section-body">
            <a href="{{ route('seller.product-select-category') }}" class="btn btn-primary"><i class="fas fa-list"></i> {{__('admin.Select Category')}}</a>
            <div class="row mt-4">
                <div class="col-12">
                <div class="card">
                        <div class="card-body">
                            <form action="{{ route('seller.store-product') }}" method="POST" enctype="multipart/form-data">
                                @csrf
