      ...
      <div class="main-content">
        <section class="section">
          ...
          <div class="section-body">
              <a href="{{ route('opa.send-email-to-all-seller') }}" class="btn btn-primary">{{__('admin.Send email to all seller')}}</a>
            <div class="row mt-4">
                <div class="col">
                  <div class="card">
                    <div class="card-body">
                            ...
                            <tbody>
                                @foreach ($sellers as $index => $seller)
                                    <tr>
                                        ...
                                        <a href="{{ route('opa.seller-show',$seller->id) }}" class="btn btn-primary btn-sm"><i class="fa fa-eye" aria-hidden="true"></i></a>

                                        <a href="{{ route('opa.send-email-to-seller',$seller->id) }}" class="btn btn-success btn-sm"><i class="far fa-envelope" aria-hidden="true"></i></a>
...
<script>
    function deleteData(id){
        $("#deleteForm").attr("action",'{{ url("opa/seller-delete/") }}'+"/"+id)
    }
