          ...
          <div class="section-body">
            <div class="row mt-4">
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                        <form action="{{ route('opa.seller.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                ...
                                @php
                                    $opa = App\Models\Setting::first();
                                @endphp
                                <div class="form-group col-12">
                                    <label>{{__('admin.Referral Code')}}</label>
                                    <input type="text" id="referral" class="form-control"  name="referral" value="{{ $referral_code }}">
                                </div>
