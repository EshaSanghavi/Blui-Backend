...
<div class="main-sidebar">
    <aside id="sidebar-wrapper">
      ...
      <ul class="sidebar-menu">
          ...
          <li class="nav-item dropdown {{ Route::is('admin.all-order') || Route::is('admin.order-show') || Route::is('admin.pending-order') || Route::is('admin.progress-order') || Route::is('admin.dispatch-ready-order') || Route::is('admin.delivered-order') ||  Route::is('admin.completed-order') || Route::is('admin.declined-order') || Route::is('admin.cash-on-delivery')  ? 'active' : '' }}">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="{{ Route::is('admin.pending-order') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.pending-order') }}">{{__('admin.On Hold')}}</a></li>

              <li class="{{ Route::is('admin.progress-order') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.progress-order') }}">{{__('admin.Confirm')}}</a></li>
              <li class="{{ Route::is('admin.dispatch-ready-order') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.dispatch-ready-order') }}">{{__('admin.Ready to Dispatch')}}</a></li>
              <li class="{{ Route::is('admin.delivered-order') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.delivered-order') }}">{{__('admin.Delivered')}}</a></li>
              <li class="{{ Route::is('admin.completed-order') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.completed-order') }}">{{__('admin.Completed')}}</a></li>

              <li class="{{ Route::is('admin.declined-order') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.declined-order') }}">{{__('admin.Cancelled')}}</a></li>
          ...
          <li class="nav-item dropdown {{ Route::is('admin.product-attribute') || Route::is('admin.product-select-category') || Route::is('admin.create-product') || Route::is('admin.product.*') || Route::is('admin.product-brand.*') || Route::is('admin.product-variant') || Route::is('admin.create-product-variant') || Route::is('admin.edit-product-variant') || Route::is('admin.product-gallery') || Route::is('admin.product-variant-item') || Route::is('admin.create-product-variant-item') || Route::is('admin.edit-product-variant-item') || Route::is('admin.product-review') || Route::is('admin.show-product-review') || Route::is('admin.seller-product') || Route::is('admin.seller-pending-product') || Route::is('admin.wholesale') || Route::is('admin.create-wholesale') || Route::is('admin.edit-wholesale') || Route::is('admin.product-highlight') ||  Route::is('admin.product-report') || Route::is('admin.show-product-report') || Route::is('admin.specification-key.*') || Route::is('admin.stockout-product') || Route::is('admin.product-import-page') ? 'active' : '' }}">
            ...
            <li class="{{ Route::is('admin.product-attribute') || Route::is('admin.attribute-store') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.product-attribute') }}">{{__('admin.Product Attributes')}}</a></li>

            <li class="{{ Route::is('admin.product-select-category') || Route::is('admin.create-product') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.product-select-category') }}">{{__('admin.Create Product')}}</a></li>
        ...
        <!-- <li class="nav-item dropdown {{ Route::is('admin.show-report') ? 'active' : '' }}"><a class="nav-link"><i class="fas fa-chart-area"></i> <span>{{__('admin.Report & Analysis')}}</span></a></li>      -->

            <li class="nav-item dropdown {{ Route::is('admin.sales-report') || Route::is('admin.earning-report') ||  Route::is('admin.vendor-sales') || Route::is('admin.transaction-report') ? 'active' : '' }}"> <a href="#" class="nav-link has-dropdown"><i class="fas fa-chart-line"></i><span>{{__('admin.Sales & Transaction Reports')}}</span></a>

            <ul class="dropdown-menu">
            
            <li class="{{ Route::is('admin.earning-report') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.earning-report') }}">{{__('admin.Earning Reports')}}</a></li>
            
            <!-- <li><a class="nav-link" href="{{ route('admin.inhouse-sales') }}">{{__('admin.Inhouse Sales')}}</a></li> -->
            
            <li class="{{ Route::is('admin.vendor-sales') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.vendor-sales') }}">{{__('admin.Vendor Sales')}}</a></li>
            
            <li class="{{ Route::is('admin.transaction-report') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.transaction-report') }}">{{__('admin.Transaction report')}}</a></li>
            </ul>
            </li>

        
             
            <li class="{{ Route::is('admin.all-product-report') || Route::is('admin.all-product-report') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.all-product-report') }}"><i class="fas fa-chart-bar"></i> <span>{{__('admin.Product Report')}}</span></a></li>
            
            <li class="{{ Route::is('admin.order-report') || Route::is('admin.show-order-report') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.order-report') }}"><i class="fas fa-chart-pie"></i><span>{{__('admin.Order Report')}}</span></a></li>
          ...
          <li class="nav-item dropdown {{ Route::is('admin.seller-raised-support-ticket') || Route::is('admin.seller-resolved-support-ticket') || Route::is('admin.opa-raised-support-ticket') || Route::is('admin.opa-resolved-support-ticket') ? 'active' : '' }}">
            <a href="#" class="nav-link has-dropdown"><i class="fas fa-users-cog"></i><span>{{__('admin.Support Ticket')}}</span></a>

            <ul class="dropdown-menu">
            
              <li class="{{ Route::is('admin.seller-raised-support-ticket') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.seller-raised-support-ticket') }}">{{__('admin.Seller Support Tickets')}}</a></li>
              <li class="{{ Route::is('admin.opa-raised-support-ticket') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.opa-raised-support-ticket') }}">{{__('admin.OPA Support Tickets')}}</a></li>
            </ul>
          </li>


          <li class="nav-item dropdown {{  Route::is('admin.customer-list') || Route::is('admin.customer-show') || Route::is('admin.pending-customer-list')  || Route::is('admin.email-history') || Route::is('admin.send-email-to-all-seller') || Route::is('admin.send-email-to-all-customer') ? 'active' : '' }}">
            <a href="#" class="nav-link has-dropdown"><i class="fas fa-user"></i><span>{{__('admin.Customers')}}</span></a>
            <ul class="dropdown-menu">
          ...
          <li class="nav-item dropdown {{ Route::is('admin.seller-create') || Route::is('admin.seller-list') || Route::is('admin.seller-show') || Route::is('admin.pending-seller-list') || Route::is('admin.seller-shop-detail') || Route::is('admin.seller-reviews') || Route::is('admin.show-seller-review-details') || Route::is('admin.send-email-to-seller') || Route::is('admin.email-history') || Route::is('admin.product-by-seller') || Route::is('admin.send-email-to-all-seller') ? 'active' : '' }}">
            <a href="#" class="nav-link has-dropdown"><i class="fas fa-user"></i><span>{{__('admin.Sellers')}}</span></a>
            <ul class="dropdown-menu">
            <li class="{{ Route::is('admin.seller-create')  ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.seller-create') }}">{{__('admin.Add New Seller')}}</a></li>
          ...
          <li class="nav-item dropdown {{ Route::is('admin.opa-create') || Route::is('admin.opa-list') || Route::is('admin.opa-show') || Route::is('admin.pending-opa-list')? 'active' : '' }}">
            <a href="#" class="nav-link has-dropdown"><i class="fas fa-user"></i><span>{{__('admin.OPA')}}</span></a>
            <ul class="dropdown-menu">
            <li class="{{ Route::is('admin.opa-create')  ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.opa-create') }}">{{__('admin.Add New OPA')}}</a></li>
    
            <li class="{{ Route::is('admin.opa-list') || Route::is('admin.opa-show') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.opa-list') }}">{{__('admin.OPA List')}}</a></li>

                <li class="{{ Route::is('admin.pending-opa-list') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.pending-opa-list') }}">{{__('admin.Pending OPA List')}}</a></li>
