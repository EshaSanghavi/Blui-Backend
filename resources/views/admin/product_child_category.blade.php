                    ...
                    <div class="card-body">
                      <div class="table-responsive table-invoice">
                        <table class="table table-striped" id="dataTable">
                            <thead>
                                <tr>
                                    <th width="3%">{{__('admin.SN')}}</th>
                                    <th width="15%">{{__('admin.Child Category')}}</th>
                                    <th width="3%">{{__('admin.Priority')}}</th>
                                    <th width="5%">{{__('admin.Commission')}}</th>
                                    <th width="15%">{{__('admin.Slug')}}</th>
                                    <th width="15%">{{__('admin.Sub Category')}}</th>
                            ...
                            <tbody>
                                @foreach ($childCategories as $index => $childCategory)
                                    <tr>
                                        ...
                                        <td>{{ $childCategory->priority }}</td>
                                        <td>{{ $childCategory->commission }}%</td>
