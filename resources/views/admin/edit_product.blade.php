                                    ...
                                    <legend class="w-auto">Product Details</legend>
                                        ...
                                        <div class="row ml-0">
                                            ...
                                            <div class="form-group col-4">
                                                ...
                                                <select name="child_category" class="form-control select2" id="child_category">
                                                    ...
                                                    @if ($product->sub_category_id != 0 && $product->child_category_id != '')
                                        ...
                                        <div class="row ml-0">
                                            ...
                                            <div class="form-group col-7">
                                                ...
                                                <input type="text" class="form-control"  name="video_link" style="width: 80%;" value="{{ $product->video_link }}">
                                                    ...
                                                    <div class="form-group col-6">
                                                        ...
                                                        @php
                                                            ...
                                                            if(count($values) === 0){
                                                                ...
                                                                $product_att = ProductAttribute::where('attribute_id', $att->id)->where('product_id', $product->id)->first();
                                                                echo '<select class="form-control" name="' . $att->name . '" id="' . $att->name . '_other" onchange="otherValue(this)">';
                                                                if($product_att)
                                                                    echo '<option value="' . $product_att->value . '" selected>' . $product_att->value . '</option>';
                                                                else
