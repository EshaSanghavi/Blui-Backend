...
@section('title')
<title>{{__('admin.Order Report')}}</title>
@endsection
      ...
      <div class="main-content">
        <section class="section">
          <div class="section-header">
            <h1>{{__('admin.Order Report')}}</h1>
            <div class="section-header-breadcrumb">
              <div class="breadcrumb-item active"><a href="{{ route('admin.dashboard') }}">{{__('admin.Dashboard')}}</a></div>
              <div class="breadcrumb-item">{{__('admin.Order Report')}}</div>
            </div>
          </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
              <div class="card card-statistic-1">
                ...
                <div class="card-wrap">
                  <div class="card-header">
                    <h4>{{__('admin.Total Completed Order')}}</h4>
                  </div>
                  <div class="card-body">
                    {{ $totalCompleteOrder }}
                  </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
              <div class="card card-statistic-1">
                ...
                <div class="card-wrap">
                  <div class="card-header">
                    <h4>{{__('admin.Total Cancelled Order')}}</h4>
                  </div>
                  <div class="card-body">
                    {{ $totalDeclinedOrder }}
                  </div>
