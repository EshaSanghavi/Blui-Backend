      ...
      <div class="main-content">
        <section class="section">
          ...
          <div class="section-body">   
            <!--<button type="button" class="btn btn-warning btn-sm" onClick="updateStatus">Update Status</button> -->
            
            <form action="{{ route('admin.update-order-status') }}" method="POST" id="updateForm">
                {{ csrf_field() }}
                 <input type="hidden" id="orderIds" name="orderIds" value=''>
                <button type="submit" class="btn btn-warning">{{__('admin.Update Status')}}</button>
            </form>
                        ...
                        <table class="table table-striped" id="dataTable"> 
                            ...
                            <tbody>
                                @foreach ($orders as $index => $order)
                                  <tr>
                                      <td><input type="checkbox" name="check-order" value="{{$order->order_id}}" onchange="checkThis()"></td>
                                      <td>{{ ++$index }}</td>
