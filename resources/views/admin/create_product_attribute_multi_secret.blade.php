...
@section('title')
<title>{{__('admin.Product Attribute Secret')}}</title>
@endsection
        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item">{{__('admin.New Product Attribute')}}</div>
            </div>
          </div>
            ...
            <div class="row mt-4">
                <div class="col">
                    <div class="card">
                        ...
                        <form id="attribute_form" action="{{ route('admin.product-attribute-secret-store') }}" method="POST" enctype="multipart/form-data">
                          @csrf

                            
                            <div class="row">
                                <div class="form-group col-12">
                                    <label>{{__('admin.Attribute Names')}}</label>
                                    <br>
                                    <input type="text" id="names" name="names" placeholder="Enter values" data-role="tagsinput" style="width:100%;">
                                </div>
                            </div>
                            ...
                            <div class="row">
                              <div class="form-group col-12">
                                ...
                                <input type="text" name="priority" id="priority" class="form-control" value="1" >   
                              </div>  
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-4 category d-none">
                                    <div class="form-group m-0">
                                        ...
                                        <div class="row">
                                            @foreach ($categoryData['subcategories'] as $subcategoryData)
                                                <div class="col-12 category_{{ $categoryData['category_id'] }} d-none pl-5">
                                                    <div class="form-group m-0">
                                                        ...
                                                        <div class="row">
                                                            @foreach ($subcategoryData['childcategories'] as $childCategory => $cat)
                                                                <div class="col-12 subcategory_{{ $subcategoryData['subcategory_id'] }} d-none pl-5">
                                                                    <div class="form-group m-0">
                                                                        <div class="border rounded px-3 py-2 min-h-20 d-flex justify-content-between gap-3 mt-1">
                                                                            ...
                                                                            <label class="switcher">
                                                                                <input class="switcher_input category" value="{{ $childCategory }}" type="checkbox" name="child_category[]" id="switcher_input_childcategory">
                                                                                <span class="switcher_control"></span>
                                                                            </label>
                                                                        </div> 
                                                                    </div>
