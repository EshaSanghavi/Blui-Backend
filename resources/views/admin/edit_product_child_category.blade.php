                        ...
                        <form action="{{ route('admin.product-child-category.update',$childCategory->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <select name="priority" id="priority" class="form-control" value="{{$childCategory->priority}}">
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <input type="number" id="commission" class="form-control"  name="commission" value="{{ $childCategory->commission }}">
                                </div>
