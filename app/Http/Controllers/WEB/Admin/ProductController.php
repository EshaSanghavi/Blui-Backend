...
class ProductController extends Controller
{
    ...
    public function selectCategory()
    {
        ...
        return view('admin.create_product_select_category', compact('data'));
    }
    ...
    public function newProductCategory(Request $request)
    {
        ...
        return view('admin.create_product',compact('category_id', 'sub_category_id', 'child_category_id', 'brands','specificationKeys', 'attributes'));
    ...
    public function edit($id)
    {
        ...
        $sub_category_id = $subCategories ? $subCategories->id : 0;
        $child_category_id = $childCategories ? $childCategories->id : 0;
        ...
        $childCategories = ChildCategory::where('sub_category_id', '=', $sub_category_id)->get();

        return view('admin.edit_product',compact('product', 'categories', 'subCategories', 'childCategories', 'specificationKeys', 'attributes'));
