...
class MegaMenuSubCategoryController extends Controller
{
    ...
    public function index($id){
        ...
        $subCategories = MegaMenuSubCategory::with('subCategory')->where('mega_menu_category_id', $id)->orderBy('priority','asc')->get();
    ...
    public function update(Request $request, $id){
        ...
        $megaMenuSubCategory->priority = $request->priority;
