...
class DeliveryManController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($request->man_image){
            ...
            Image::make($request->man_image)->save($man_image_name);
        ...
        if($request->idn_image){
            ...
            Image::make($request->idn_image)->save($idn_image_name);
    ...
    public function update(Request $request, $id)
    {
        ...
        if($request->man_image){
            ...
            $man->man_image = $man_image_name;
            if($man_old_image){
                if(File::exists($man_old_image))unlink($man_old_image);
            }
        }
        $man->fname=$request->fname;
        $man->lname=$request->lname;
        ...
        if($request->idn_image){
            ...
            $man->idn_image = $idn_image_name;
            if($idn_old_image){
                if(File::exists($idn_old_image))unlink($idn_old_image);
            }
        }
        $man->phone=$request->phone;
        $man->save();
