...
class ProductChildCategoryController extends Controller
{
    ...
    public function getSubcategoryByCategory($id){
        ...
        $response="<option value=''>".trans('admin.Select Sub Category')."</option>";
    ...
    public function getChildcategoryBySubCategory($id){
        ...
        $response='<option value="">'.trans('admin.Select Child Category').'</option>';
    ...
    public function store(Request $request)
    {
        ...
        $customMessages = [
            ...
            'commission.required' => trans('admin_validation.Commission is required'),
        ...
        $childCategory->commission = $request->commission;
    ...
    public function update(Request $request, $id)
    {
        ...
        $customMessages = [
            ...
            'slug.required' => trans('admin_validation.Slug is required'),
            'slug.unique' => trans('admin_validation.Slug already exist'),
            'priority.required' => trans('admin_validation.Priority is reuired'),
            'category.required' => trans('admin_validation.Category is required'),
            'sub_category.required' => trans('admin_validation.Sub category is required'),
        ];
        $this->validate($request, $rules,$customMessages);
